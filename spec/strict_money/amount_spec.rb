RSpec.describe StrictMoney::Amount do
  ...
  it "does not define setters or getters for #fractional or #amount" do
    subject = described_class.new(10, 'USD')
    expect { subject.fractional }.to raise_error(NoMethodError)
    expect { subject.fractional = 2 }.to raise_error(NoMethodError)
  ...
  it "does not allow instantiation if either fractional or currency is undefined" do
    expect {
